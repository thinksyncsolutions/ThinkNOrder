    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      {sections.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-18 px-4 border-2 border-dashed border-orange-200 rounded-[3rem] bg-orange-50/30">
          ...
          <h3 className="text-2xl font-black text-orange-950 uppercase italic">
            No Menu Found
          </h3>
      ...
      section.items.map((item) => (
        <div
          ...
          className={`flex items-center justify-between p-4 rounded-2xl hover:bg-orange-50/30 transition-all border border-transparent hover:border-orange-100 group/item ${
            !item.isAvailable ? "opacity-60 bg-gray-50/50" : ""
          }`}
        >
          <div className="flex items-center gap-4">
            <ChevronRight
            ...
            <div>
              <div className="flex items-center gap-3">
                ...
                {!item.isAvailable && (
                  <span className="text-[8px] font-black bg-red-100 text-red-600 px-2 py-0.5 rounded uppercase tracking-widest">
                    Out of Stock
                  </span>
                )}
              </div>
